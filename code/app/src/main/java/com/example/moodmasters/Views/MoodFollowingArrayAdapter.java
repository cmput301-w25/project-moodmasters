...
public class MoodFollowingArrayAdapter extends ArrayAdapter<MoodEvent> implements MVCView {
    private Context context;
    public MoodFollowingArrayAdapter(Context context, ArrayList<MoodEvent> mood_events) {
