...
public class FollowRequestsScreenAdapter extends BaseAdapter{
    private Context context;
    private List<String> requests;
    private FirebaseFirestore db;
    private String currentUsername;

    public FollowRequestsScreenAdapter(Context context, List<String> requests, FirebaseFirestore db) {
