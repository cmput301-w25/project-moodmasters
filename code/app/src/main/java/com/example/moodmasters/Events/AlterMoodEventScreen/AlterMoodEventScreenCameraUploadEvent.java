...
public class AlterMoodEventScreenCameraUploadEvent implements MVCController.MVCEvent {
    private DialogFragment fragment;
    public AlterMoodEventScreenCameraUploadEvent(DialogFragment init_fragment){
