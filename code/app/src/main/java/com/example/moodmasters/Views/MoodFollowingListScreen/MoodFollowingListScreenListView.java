...
public class MoodFollowingListScreenListView implements MVCView {
    private ListView mood_following_list;
    private MoodFollowingListScreenAdapter mood_following_adapter;
    private Context context;
    private boolean isSorted = false; // Track if the list is sorted
    private List<MoodEvent> original_list; // Store original order
    public MoodFollowingListScreenListView(Context init_context){
        context = init_context;
        mood_following_list = ((MoodFollowingListScreenActivity) context).findViewById(R.id.mood_following_list);
    ...
    public void initialize(MVCModel model){
        ...
        mood_following_adapter = new MoodFollowingListScreenAdapter(context, model.getBackendList(BackendObject.State.MOODFOLLOWINGLIST));
    ...
    public MoodFollowingListScreenAdapter getMoodFollowingArrayAdapter(){
