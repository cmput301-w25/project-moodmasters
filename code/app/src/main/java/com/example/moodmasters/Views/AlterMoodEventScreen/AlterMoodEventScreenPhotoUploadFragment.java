...
public class AlterMoodEventScreenPhotoUploadFragment extends DialogFragment implements MVCView {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        galleryButton.setOnClickListener(v -> {
            controller.execute(new AlterMoodEventScreenUploadFromGallery(this), getContext());
        });

        cameraButton.setOnClickListener(v -> {
            controller.execute(new AlterMoodEvenScreenUploadFromCamera(this), getContext());
        });
